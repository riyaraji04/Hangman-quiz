     ...
     public OnlineTest()
            {
             ...
             image=new ImageIcon(getClass().getResource("img8.png"));
    ...
    {  
        ...
        {  
            ...
            JOptionPane.showMessageDialog(this,"congratulations you win!");
             ...
             JOptionPane.showMessageDialog(this,"correct ans="+count+"\n"+"The correct answers for all the provided questions are: "+"\n"+ "1.Float "+"\n"+"2.Object"+"\n"+" 3.lang "+"\n"+"4.lang"+"\n"+ "5.SSS IT "+"\n"+"6.get"+"\n"+" 7.Actionperformed"+"\n"+" 8.getDocumentBase "+"\n"+" 9.main "+"\n"+"10.JButtonGroup"); 
         ...
         { 
            ...
            if(count==10)
            {
             ...
             ImageIcon icon=new ImageIcon("img8.jpg");
             ...
             if(count==6||count==5)
            {
             ...
             JFrame frame1=new JFrame();
             ImageIcon icon1=new ImageIcon("img3.png");
             JLabel lb1=new JLabel(icon1);
             frame1.add(lb1);
             frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
             frame1.pack();
             ...
             if(count==4)
            {
             ...
             JFrame frame1=new JFrame();
             ImageIcon icon1=new ImageIcon("img4.png");
             JLabel lb1=new JLabel(icon1);
             frame1.add(lb1);
             frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
             frame1.pack();
            ...
            if(count==3)
            {
             ...
             JFrame frame1=new JFrame();
             ImageIcon icon1=new ImageIcon("img5.png");
             JLabel lb1=new JLabel(icon1);
             frame1.add(lb1);
             frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
             frame1.pack();
             ...
             if(count==2)
            {
             ...
             JFrame frame1=new JFrame();
             ImageIcon icon1=new ImageIcon("img6.png");
             JLabel lb1=new JLabel(icon1);
             frame1.add(lb1);
             frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
             frame1.pack();
             ...
             if(count==1)
            {
             ...
             JFrame frame1=new JFrame();
             ImageIcon icon1=new ImageIcon("img7.png");
             JLabel lb1=new JLabel(icon1);
             frame1.add(lb1);
             frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
             frame1.pack();
